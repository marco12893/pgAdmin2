...
//            userList.remove(selectedUser);
    ...
    public void bukaJemaat () throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("data_jemaat.fxml"));
        Parent root = loader.load();

        Data_JemaatController controller = loader.getController();
        Stage primaryStage = new Stage();
        controller.setStage(primaryStage);

        primaryStage.setTitle("Jemaat");
